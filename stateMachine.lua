...
stateMachine = {
  ...
  highlightFind = true,
  highlightClick = true,
  wholeWindow = Region(0, 0, 1280, 720),
  stateBox = Region(300, 0, 100, 20),
  debugBox = Region(400, 0, 400, 20),
  lastScreen = nil,
  waitStatesDebounce = 1.0,
...
function stateMachine:find(region, image, timeout)
  ...
  local m = region:exists(image, timeout or 1)
